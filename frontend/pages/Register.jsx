...
function Register() {
  ...
  const [confirmPassword, setConfirmPassword] = useState(""); // <-- FIX 1: Added new state
          ...
          <div className="w-full md:w-1/2 p-8 md:p-12">
            ...
            <form onSubmit={handleSignUp}>
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full bg-blue-600  cursor-pointer text-white font-semibold py-3 px-4 rounded-lg hover:bg-blue-700 transition-colors duration-300 disabled:bg-gray-400"
              >
